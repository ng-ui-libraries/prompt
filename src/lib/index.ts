...
export {PromptComponent}        from './Component/PromptComponent';
export {PromptBodyComponent}    from './Component/PromptBodyComponent';
export {PromptHeaderComponent}  from './Component/PromptHeaderComponent';
